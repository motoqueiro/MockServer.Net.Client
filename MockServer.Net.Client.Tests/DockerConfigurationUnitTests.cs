namespace MockServer.Net.Client.UnitTests
{
    ...
    public class DockerConfigurationUnitTests
    {
        ...
        [TestCase(null, null, null, null, null, null, "run -d -P jamesdbloom/mockserver")]
        [TestCase(1080, 1090, null, null, null, null, "run -d -p 1080:1080 -p 1090:1090 jamesdbloom/mockserver")]
        [TestCase(1080, null, null, null, null, null, "run -d -p 1080:1080 jamesdbloom/mockserver")]
        [TestCase(null, 1090, null, null, null, null, "run -d -p 1090:1090 jamesdbloom/mockserver")]
        [TestCase(1080, 1090, null, null, LogLevelEnum.INFO, null, "run -d -p 1080:1080 -p 1090:1090 jamesdbloom/mockserver /opt/mockserver/run_mockserver.sh -logLevel INFO -serverPort 1080 -proxyPort 1090")]
        [TestCase(null, 1090, 80, "www.mock-server.com", null, null, "run -d -p 1090:1090 jamesdbloom/mockserver /opt/mockserver/run_mockserver.sh -proxyPort 1090 -proxyRemotePort 80 -proxyRemoteHost www.mock-server.com")]
        [TestCase(1080, 1090, 80, "www.mock-server.com", null, " - Dmockserver.enableCORSForAllResponses=true -Dmockserver.sslSubjectAlternativeNameDomains='org.mock-server.com,mock-server.com'", "run -d -p 1080:1080 -p 1090:1090 jamesdbloom/mockserver /opt/mockserver/run_mockserver.sh -logLevel INFO -serverPort 1080 -proxyPort 1090 -proxyRemotePort 80 -proxyRemoteHost www.mock-server.com -genericJVMOptions \"-Dmockserver.enableCORSForAllResponses=true -Dmockserver.sslSubjectAlternativeNameDomains='org.mock-server.com,mock-server.com'\"")]
